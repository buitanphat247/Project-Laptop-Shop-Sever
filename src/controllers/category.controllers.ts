...
// controllers/category.controllers.ts
 ...
 * }
 */
const getProductByIdCategory = async (req: Request, res: Response) => {
...
export { getCategory, createCategory, getCategoryById, getProductByIdCategory, deleteCategoryById, updateCategoryById };
