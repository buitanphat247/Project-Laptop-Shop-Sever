...
export const updateConversation = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { lastMessage, lastMessageAt, unreadCountUser1, unreadCountUser2 } =
      req.body;
    ...
    const conversation = await prisma.conversation.update({
      ...
      data: {
        ...
        unreadCountUser1:
          unreadCountUser1 !== undefined
            ? parseInt(unreadCountUser1)
            : undefined,
        unreadCountUser2:
          unreadCountUser2 !== undefined
...
export const getConversationsByUser1Id = async (
  req: Request,
  res: Response
) => {
  try {
...
export const getConversationsByUser2Id = async (
  req: Request,
  res: Response
) => {
  try {
...
export const deleteMessagesForUser = async (req: Request, res: Response) => {
  try {
...
export const deleteAllMessagesForUser = async (req: Request, res: Response) => {
  try {
    const { userId } = req.params;
    const userIdInt = parseInt(userId);
