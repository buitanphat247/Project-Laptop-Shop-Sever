 ...
 */
orderRouter.post("/create-order", auth_middleware_1.verifyToken, auth_middleware_1.checkPermission, order_controllers_1.createOrder);
/**
 ...
 * @returns {message: string, data: Order}
 */
orderRouter.get("/get-order/:id", auth_middleware_1.verifyToken, auth_middleware_1.checkPermission, order_controllers_1.getOrderById);
/**
 ...
 * @returns {message: string, data: Order[]}
 */
orderRouter.get("/orders-of-user/:userId", auth_middleware_1.verifyToken, auth_middleware_1.checkPermission, order_controllers_1.getOrdersByUserId);
/**
 * @route GET /orders
 ...
 */
orderRouter.get("/orders", auth_middleware_1.verifyToken, auth_middleware_1.checkPermission, (0, auth_middleware_1.authorize)("admin"), order_controllers_1.getAllOrders);
/**
 ...
 * @returns {message: string, data: Order}
 */
orderRouter.put("/update-order/:id", auth_middleware_1.verifyToken, auth_middleware_1.checkPermission, (0, auth_middleware_1.authorize)("admin"), order_controllers_1.updateOrderById);
/**
 ...
 * @returns {message: string, data: Order}
 */
orderRouter.delete("/delete-order/:id", auth_middleware_1.verifyToken, auth_middleware_1.checkPermission, (0, auth_middleware_1.authorize)("admin"), order_controllers_1.deleteOrderById);
 ...
 */
orderRouter.post("/payment-vnpay", payment_controllers_1.createVNPayPayment);
/**
 ...
 */
orderRouter.get("/vnpay-return", payment_controllers_1.handleVNPayReturn);
