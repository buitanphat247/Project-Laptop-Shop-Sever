...
exports.orderSuccessTemplate = exports.forgotPasswordTemplate = void 0;
const forgotPasswordTemplate = ({ user, otp, appName, otpExpireMinutes, }) => `
<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8" />
...
const orderSuccessTemplate = ({ customerName, orderId, orderDate, paymentMethod, itemsHtml, totalPrice, shipAddress, shipPhone, appName = "LaptopShop", orderLink = "https://example.com", year = new Date().getFullYear(), }) => `
<!DOCTYPE html>
<html lang="vi">
  <head>
    <meta charset="UTF-8" />
...
`;
exports.orderSuccessTemplate = orderSuccessTemplate;
